        ...
        <Layout>
            ...
            <section className="flex justify-between px-5 py-2 mb-3 bg-[#4c5165]">
                <div className='flex justify-center items-center'>
                    <h1 className="font-bold text-sm md:text-lg text-white mr-2">Product Category</h1>
                    {loading ? (
                    ...
                    <Datatable
                        columns={['name'].map(key => ({
                            ...
                            Cell: ({ cell }) => {
                                ...
                                return <span title={displayValue}>{displayValue.slice(0, 40)}{displayValue.length > 40 && '...'}</span>;
                            }
                        }))}
                        data={data}
                        onEdit={handleEdit}
